...
- ### Types of Blocks
  - ![Block Types](/chatbot/typesnew.png)
    There are eight types of blocks in Scratch. Each type lets you control the game in a different way. You can also make your own blocks.
- ### First Block
  - ![Starting a Game](/chatbot/intro.png)
    This is an example block of Scratch. When you click on a sprite, it will say two lines, each for two seconds.
- ### Function Blocks
  - ![Events](/chatbot/starters.png)
    Custom blocks called "functions" let you fit large and complex blocks of code into one small block for repeated use.
- ### Full Game
  - ![Tjhe Full Block](/chatbot/full.png)
    For example, this function is named Guessing Game, and it executes code that simulates a guessing game. When you "call" the function, or use it in other blocks of code, the contents of this function are performed.
- ### Gameflow
